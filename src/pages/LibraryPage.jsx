...
import heroImg_LibraryPage from "../assets/indian_campus_library.png";
    ...
    <div className="bg-white min-h-screen pb-24">
      ...
      <div className="relative w-full min-h-[520px] overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg_LibraryPage} alt="Hero Background" className="w-full h-full object-cover" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 xl:px-12 mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          ...
          <FadeInUp delay={150}>
            <div className="py-12 px-6 lg:px-12 bg-[#0F766E] rounded-2xl h-full text-white">
              <div className="flex items-center gap-3 mb-8">
