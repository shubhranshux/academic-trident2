...
import heroImg_PrivacyPolicyPage from "../assets/hero-bg-new.jpg";
    ...
    <div className="bg-white min-h-screen pb-24">
      <div className="relative w-full h-[40vh] min-h-[300px] max-h-[400px] bg-[#1a2352] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg_PrivacyPolicyPage} alt="Hero Background" className="w-full h-full object-cover" />
