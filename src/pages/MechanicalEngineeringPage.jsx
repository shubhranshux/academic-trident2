...
/* ══════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════ */
const mechanicalEngineeringStyles = `
  .mechanical-engineering-bg {
    background: radial-gradient(circle at top left, #f0f9ff 0%, #e0f2fe 50%, #e0e7ff 100%);
  }

  .glass-card-mechanical-engineering {
...
/* ══════════════════════════════════════════════
   CUSTOM SIDEBAR
   ══════════════════════════════════════════════ */
function MechanicalEngineeringSidebar({ data, activeSection }) {
  return (
    <aside className="hidden xl:block sticky top-[100px] self-start w-[300px] shrink-0 z-20 h-[calc(100vh-120px)]">
      <div className="h-full flex flex-col p-5 rounded-3xl glass-card-mechanical-engineering relative overflow-hidden">
        ...
        <div className="relative mb-5 pb-3 border-b border-[#2563eb]/20 z-10">
          <h3 className="text-[#0369a1] text-[13px] font-black uppercase tracking-[0.15em] whitespace-pre-line leading-snug">
            {data.sidebar.heading || 'MECHANICAL\nENGINEERING'}
          </h3>
        </div>
        ...
        <nav className="flex-1 min-h-0 flex flex-col gap-0.5 z-10 sidebar-scroll pr-1 pb-2">
          {data.sidebar.items.map((item) => {
            ...
            const targetUrl = `/mechanical-engineering/${item.id}`;
...
/* ══════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════ */
export default function MechanicalEngineeringPage({ isHome }) {
  const params = useParams();
  const subpage = isHome ? 'home' : (params.subpage || 'overview');
  const data = getDepartment('mechanical-engineering');
      ...
      case 'home':
        return (
          <div className="space-y-16">
            <section className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden">
        ...
        return (
          <div className="space-y-16">
            <section className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden">
              ...
              <FadeInUp delay={300}>
                <div className="glass-card-mechanical-engineering rounded-3xl overflow-hidden bg-white/40 border border-[#2563eb]/20">
      ...
      case 'syllabus':
        return (
          <div className="space-y-12">
            ...
            <FadeInUp delay={100}>
              <div className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl bg-white/70">
        ...
        return (
          <div className="space-y-12">
            ...
            {data.faculty && data.faculty.length > 0 ? (
              <FadeInUp delay={100}>
                <div className="glass-card-mechanical-engineering rounded-3xl overflow-hidden">
              ...
              <FadeInUp delay={100}>
                <div className="glass-card-mechanical-engineering p-12 rounded-3xl text-center">
                ...
                data.laboratories.map((lab, idx) => {
                  ...
                  return (
                    <FadeInUp key={idx} delay={idx * 80}>
                      <div className="glass-card-mechanical-engineering rounded-3xl overflow-hidden transition-all duration-300">
                        <button 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {data.placement && data.placement.map((item, idx) => (
                  <a
                    ...
                    className="group glass-card-mechanical-engineering p-8 rounded-3xl flex flex-col items-center justify-center gap-4 hover:-translate-y-2 hover:bg-white/60 transition-all duration-300 relative overflow-hidden shadow-sm"
                  >
            ...
            <FadeInUp delay={100}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {data.startup && data.startup.map((item, idx) => (
                  <div key={idx} className="glass-card-mechanical-engineering p-8 md:p-10 rounded-3xl flex flex-col justify-between group hover:bg-white/60 transition-all duration-300 shadow-sm relative overflow-hidden">
            ...
            <FadeInUp delay={100}>
              <div className="grid grid-cols-1 gap-8">
                {data.clubs && data.clubs.map((club, idx) => (
                  <div key={idx} className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl flex flex-col md:flex-row gap-8 items-center md:items-start group hover:bg-white/60 transition-all duration-300 shadow-sm relative overflow-hidden">
      ...
      case 'bput-questions':
        return (
          <div className="space-y-12">
            ...
            {data.bputQuestions && (
              <FadeInUp delay={100}>
                <div className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden group hover:bg-white/60 transition-all duration-300">
      ...
      case 'lecture-notes':
        return (
          <div className="space-y-12">
            ...
            <FadeInUp delay={100}>
              <div className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden mb-10">
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-[#2563eb]/5 to-transparent rounded-bl-full pointer-events-none"></div>
            ...
            <FadeInUp delay={200}>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.lectureNotes && data.lectureNotes.map((note, idx) => (
                  <div key={idx} className="glass-card-mechanical-engineering p-6 rounded-2xl flex flex-col justify-between group hover:bg-white/60 transition-all duration-300 shadow-sm relative overflow-hidden border border-white/50 hover:border-[#2563eb]/30">
          ...
          <div className="space-y-12">
            ...
            <FadeInUp delay={100}>
              <div className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden mb-10">
                ...
                <p className="text-[#455A64] text-[16px] font-medium leading-relaxed max-w-3xl">
                  The Department of MechanicalEngineering and Telecommunication Engineering is proud to be associated with leading professional societies. These student chapters provide a platform for networking, knowledge sharing, technical events, and bridging the gap between academia and industry.
                </p>
              </div>
            </FadeInUp>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {data.professionalSocieties && data.professionalSocieties.map((society, idx) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group glass-card-mechanical-engineering p-8 rounded-3xl flex flex-col items-center justify-center gap-4 hover:-translate-y-2 hover:bg-white/60 transition-all duration-300 shadow-sm relative overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-[#2563eb]/5 to-[#4f46e5]/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <div className="space-y-12">
            ...
            <FadeInUp delay={100}>
              <div className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden mb-10">
                ...
                <p className="text-[#455A64] text-[16px] font-medium leading-relaxed max-w-3xl">
                  Explore the annual editions of "Evoluer," our departmental magazine. It showcases the technical achievements, research insights, and creative endeavors of our students and faculty in the field of MechanicalEngineering and Telecommunication Engineering.
                </p>
              </div>
            </FadeInUp>
        ...
        return (
          <div className="space-y-12">
            ...
            {data.ingeniumNewsletter && (
              <FadeInUp delay={100}>
                <div className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden group hover:bg-white/60 transition-all duration-300 shadow-sm flex flex-col md:flex-row gap-8 items-center md:items-start">
                  <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-[#2563eb]/5 to-transparent rounded-bl-full pointer-events-none"></div>
        ...
        return (
          <div className="space-y-12">
            ...
            {data.innovationTeaching && (
              <FadeInUp delay={100}>
                <div className="glass-card-mechanical-engineering p-8 md:p-12 rounded-3xl relative overflow-hidden group hover:bg-white/60 transition-all duration-300 shadow-sm text-center flex flex-col items-center">
                  <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-[#2563eb]/5 to-transparent rounded-bl-full pointer-events-none"></div>
  ...
  return (
    <div className="min-h-screen mechanical-engineering-bg relative overflow-hidden font-sans">
      <style>{mechanicalEngineeringStyles}</style>
      ...
      <section className="relative pt-40 pb-24 z-10">
        <div className="max-w-[1400px] mx-auto px-6 xl:px-12">
          ...
          <nav className="flex items-center gap-2 text-[12px] font-bold text-[#0369a1]/70 mb-8 flex-wrap uppercase tracking-widest">
            ...
            {!isHome ? (
              <>
                <Link to="/mechanical-engineering" className="hover:text-[#0c4a6e] transition-colors">MechanicalEngineering & Telecommunication</Link>
                <ChevronRight size={12} className="text-[#0369a1]/40" />
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <FadeInUp delay={200}>
                <div className="flex flex-wrap gap-4 md:gap-6">
                    <div className="glass-card-mechanical-engineering px-6 py-5 rounded-2xl flex-1 min-w-[140px] text-center border-white/60">
            ...
            <div className="w-full lg:w-[45%] relative hidden md:block">
              <FadeInUp delay={300}>
                <div className="relative w-full aspect-square">
                  ...
                  {/* Floating Elements */}
                  <div className="absolute top-[10%] left-[5%] glass-card-mechanical-engineering p-4 rounded-full z-20 shadow-lg animate-bounce" style={{ animationDuration: '3s' }}>
                    <Cpu size={28} className="text-[#2563eb]" />
                  </div>
                  <div className="absolute bottom-[15%] right-[5%] glass-card-mechanical-engineering p-4 rounded-full z-20 shadow-lg animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 xl:px-12 pb-24 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-[30%] space-y-8 sticky top-[100px]">
            {/* The sidebar */}
            <MechanicalEngineeringSidebar data={data} activeSection={subpage} />
          </div>
        </div>
      </div>
    </div>
