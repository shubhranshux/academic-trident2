 ...
 */
export function SkewedMarquee({ items = [], bgColor = '#111827', textColor = '#E8BD63', hoverColor = '#F5D78E', speed = 30 }) {
        ...
        >
          {repeated.map((item, i) => (
            <span key={i} className="flex items-center">
              <span 
                className="font-serif text-lg md:text-xl lg:text-2xl italic font-medium tracking-wide px-8 md:px-10 lg:px-12 cursor-default transition-colors duration-300"
              ...
              <span className="w-[1px] h-5 flex-shrink-0" style={{ backgroundColor: textColor, opacity: 0.3 }} />
            </span>
          ))}
        </div>
      </div>
